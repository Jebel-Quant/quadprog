...
Deletion keeps the Givens chase. It is inherently sequential --- each rotation's
parameters depend on the previous one having been applied --- and no analogous
single-transformation form exists.
